...
<div class="body-content">
  <div class="module">
    ...
    <form class="form" action="updateServlet" method="post">
		      ...
		      <input type="text" placeholder="Password" name="time" value ="<%=Password%>" required />
		      <input type="text" placeholder="Name" name="Name" value ="<%=Name%>" required />
		      <input type="text" placeholder="Email ID" name="EmailID" value ="<%=EmailID%>" required />

		      <div class="avatar"></div>
		      <input type="submit" value="UPDATE" name="register" class="btn btn-block btn-primary" />
    </form>
     <a href="NewFile.jsp">
      	<input type="submit" value="Edit" name="register" class="btn btn-block btn-primary" />
    </a>
  </div>
</div>
</body>
